...
if __name__ == '__main__':    
    ...
    # --- Task C: Visualization step ---
    # Converts the NetCDF file produced in Task B into a PNG image using the "convert-png" Docker image.
    # The input is read from Task B's output (workflow:///B/output.nc).
    taskC = DagonTask(
        TaskType.DOCKER,
        "C",
